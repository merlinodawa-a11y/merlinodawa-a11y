...
🔭 I’m currently working on C++ console projects including basic calculators (distance, grade, temperature) , mini data processing tasks, file handling exercises and cryptography basics ( Caesar cipher and vigenere cipher). Recently I experinced working in a group where we created a visual digital story where we employed multimedia content in creating coursework.
